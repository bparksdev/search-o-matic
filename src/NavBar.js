...
const NavBar = () => {
    return (
        <div>
            <div style={{fontSize:"1.3rem",color:"#e0e0e0"}}>&copy; 2022 SkrapHeap Development</div>
            <h1 className="title">
                TV/Movie Search-O-Matic &trade;
            </h1>
            <div id="poweredby" style={{fontSize:"1.5rem",paddingRight:"5px",color:"white",textAlign:"center"}}>
                Powered By 
                &nbsp;
